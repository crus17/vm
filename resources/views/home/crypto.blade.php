...
<title>Cryptocurrency – {{$settings->site_name}}</title>	
<style>
img.wp-smiley,
img.emoji {
...
<link rel="stylesheet" id="happy-elementor-addons-1636-css" href="{{asset('main/happy-163646ef.css')}}" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-7-css" href="{{asset('main/happy-746ef.css')}}" media="all">
...
<link rel="stylesheet" id="elementor-post-1636-css" href="{{asset('main/post-1636.css')}}" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-1085-css" href="{{asset('main/happy-108546ef.css')}}" media="all">
	...
	<div class="main-header-bar">
		...
		<div class="site-branding">
			<div class="ast-site-identity" itemtype="https://schema.org/Organization" itemscope="itemscope">
				<span class="site-logo-img"><a href="\" class="custom-logo-link" rel="home"><img src="{{asset('main/logo-white.png')}}" class="custom-logo" alt="logo" srcset="" sizes="(max-width: 187px) 100vw, 187px" width="187" height="62"></a></span>			</div>
		</div>
...
online businesses in the past decade.</p><p>We support a variety of over
 ...
 Litecoin, Ripple and many more.</p></div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
										<img src="{{asset('main/cryptocurrency-3085139_640.jpg')}}" class="attachment-full size-full" alt="" loading="lazy" srcset="{{asset('main/cryptocurrency-3085139_640.jpg')}} 640w, {{asset('main/cryptocurrency-3085139_640.jpg')}} 300w" sizes="(max-width: 640px) 100vw, 640px" width="640" height="394"></div>
				</div>
				</div>
						</div>
					</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
										<img src="{{asset('main/crypto-benefit.jpg')}}" class="attachment-full size-full" alt="" loading="lazy" srcset="{{asset('main/crypto-benefit.jpg')}} 640w, {{asset('main/crypto-benefit.jpg')}} 300w" sizes="(max-width: 640px) 100vw, 640px" width="640" height="426">											</div>
				</div>
				</div>
						</div>
					</div>
...
<div class="elementor-widget-container">
	<div class="elementor-image">
						<img src="{{asset('main/logo-white.png')}}" title="logo" alt="logo" width="220px;">											</div>
</div>
</div>
...
<script src="{{asset('main/astra-addon-5f4bbe88dcbe35-54608992.js.downloa')}}d" id="astra-addon-js-js"></script>
