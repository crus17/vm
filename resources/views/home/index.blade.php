				...
				<div class="row"> 
                    <div class="col-sm-6 col-md-4 logo">
                        <a href="index.html" title="{{$settings->site_name}}">
                            <img class="light" src="{{ asset('/home/logo-3.png')}}"  width="120" alt="{{$settings->site_name}}">
            ...
            <div class="brand-logo-slider c-l p-tb white-sec">
                <div class="container">
                    ...
                    <div class="brand-logos owl-carousel">
                        <div class="item"><img src="{{ asset ('home/images/brand-logo1.png')}}" alt="Brand Logo 1" /></div>
                        <div class="item"><img src="{{ asset ('home/images/brand-logo2.png')}}" alt="Brand Logo 2" /></div>
                        <div class="item"><img src="{{ asset ('home/images/brand-logo5.png')}}" alt="Brand Logo 5" /></div>
                        <div class="item"><img src="{{ asset ('home/images/brand-logo4.png')}}" alt="Brand Logo 4" /></div>
                        <div class="item"><img src="{{ asset ('home/images/brand-logo3.png')}}" alt="Brand Logo 3" /></div>
                    </div>
                </div>
            </div>
            <!-- Brand logo end -->
