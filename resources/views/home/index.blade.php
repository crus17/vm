...
<html lang="en-US">
	...
	<link rel="stylesheet" id="happy-elementor-addons-15-css" href="{{asset('fxipro_v2/happy-15fc95.css')}}" media="all">
	...
	<link rel="stylesheet" id="happy-elementor-addons-7-css" href="{{asset('fxipro_v2/happy-7fc95.css')}}" media="all">
	...
	<link rel="stylesheet" id="happy-elementor-addons-1085-css" href="{{asset('fxipro_v2/happy-1085fc95.css')}}" media="all">
	...
	<link rel="stylesheet" id="elementor-icons-fa-brands-css" href="{{asset('fxipro_v2/brands.css')}}" media="all">
...
<body itemtype="https://schema.org/WebPage" style="background-color: black;" itemscope="itemscope" class="home page-template-default page page-id-15 wp-custom-logo ehf-footer ehf-template-astra ehf-stylesheet-astra ast-page-builder-template ast-no-sidebar astra-2.5.4 ast-header-custom-item-inside ast-single-post ast-inherit-site-logo-transparent ast-theme-transparent-header ast-inherit-site-logo-sticky elementor-default elementor-kit-7 elementor-page elementor-page-15 astra-addon-2.6.3 ast-header-break-point" data-elementor-device-mode="desktop">
																	...
																	<div class="elementor-element elementor-element-0797603 elementor-widget elementor-widget-image" data-id="0797603" data-element_type="widget" data-widget_type="image.default">
																		<div class="elementor-widget-container">
																			<div class="elementor-image">
																				<img src="{{asset('fxipro_v2/robot.jpg')}}" class="attachment-large size-large" alt="" loading="lazy" srcset="{{asset('fxipro_v2/robot.jpg')}} 1000w, {{asset('fxipro_v2/robot.jpg')}} 300w, {{asset('fxipro_v2/robot.jpg')}} 768w" sizes="(max-width: 1000px) 100vw, 1000px" width="1000" height="800">
																			</div>
																		</div>
																	</div>
																</div>
																				...
																				<div class="col-md-4 col-sm-6">
																					<div class="feature-item">
																						<div class="feature-icon">
																							<img src="{{asset('fxipro_v2/1.png')}}" alt="">
																						</div>
																			...
																			<center>
																				<div class="col-md-4 col-sm-6">
																					<div class="feature-item feature-p">
																						<div class="feature-icon">
																							<img src="{{asset('fxipro_v2/4.png')}}" alt="">
																						</div>
																						<div class="feature-text">
																		...
																		<div class="elementor-widget-container">
																			<center>
																				<div class="col-md-4 col-sm-6">
																					<div class="feature-item feature-p">
																						<div class="feature-icon">
																							<img src="{{asset('fxipro_v2/2.png')}}" alt="">
																						</div>
																						<div class="feature-text">
																		...
																		<div class="elementor-widget-container">
																			<center>
																				<div class="col-md-4 col-sm-6">
																					<div class="feature-item">
																						<div class="feature-icon">
																							<img src="{{asset('fxipro_v2/5.png')}}" alt="">
																						</div>
																						<div class="feature-text">
																							<h3>Secure Wallet</h3>
																		...
																		<div class="elementor-widget-container">
																			<center>
																				<div class="col-md-4 col-sm-6">
																					<div class="feature-item">
																						<div class="feature-icon">
																							<img src="{{asset('fxipro_v2/3.png')}}" alt="">
																						</div>
																						<div class="feature-text">
																		...
																		<div class="elementor-widget-container">
																			<center>
																				<div class="col-md-4 col-sm-6">
																					<div class="feature-item feature-p">
																						<div class="feature-icon">
																							<img src="{{asset('fxipro_v2/6.png')}}" alt="">
																						</div>
																						<div class="feature-text">
																		...
																		<div class="elementor-widget-container">
																			<center>
																				<div class="col-md-4 col-sm-6">
																					<div class="service-item">
																						<div class="service-icon">
																							<img src="{{asset('fxipro_v2/7.png')}}" alt="">
																						</div>
																						<h3>Make Payments</h3>
																		...
																		<div class="elementor-widget-container">
																			<center>
																				<div class="col-md-4 col-sm-6">
																					<div class="service-item">
																						<div class="service-icon">
																							<img src="{{asset('fxipro_v2/8.png')}}" alt="">
																						</div>
																						<h3>Choose a Plan</h3>
																			...
																			<div class="elementor-price-table">
																				...
																				<ul class="elementor-price-table__features-list">
																					...
																					<li class="elementor-repeater-item-4e4d4c1">
																						<div class="elementor-price-table__feature-inner">
																							<img src="{{asset('fxipro_v2/eye.png')}}" aria-hidden="true">
																							<span>
																								Referral percent: 35%
																							</span>
																						</div>
																				...
																				<div class="premium-testimonial-container">
																					...
																					<div class="premium-testimonial-content-wrapper">
																						<div class="premium-testimonial-img-wrapper circle">
																							<img src="{{asset('fxipro_v2/team-s2.jpg')}}" alt="team-s2.jpg" class="premium-testimonial-person-image">
																						</div>
																		...
																		<div class="elementor-widget-container">
																			...
																			<div class="premium-testimonial-box">
																				<div class="premium-testimonial-container">
																					...
																					<div class="premium-testimonial-content-wrapper">
																						<div class="premium-testimonial-img-wrapper circle">
																							<img src="{{asset('fxipro_v2/team-s10.jpg')}}" alt="team-s10.jpg" class="premium-testimonial-person-image">
																						</div>
																		...
																		<div class="elementor-widget-container">
																			...
																			<div class="premium-testimonial-box">
																				<div class="premium-testimonial-container">
																					...
																					<div class="premium-testimonial-content-wrapper">
																						<div class="premium-testimonial-img-wrapper circle">
																							<img src="{{asset('fxipro_v2/team-s8.jpg')}}" alt="team-s8.jpg" class="premium-testimonial-person-image">
																						</div>
																					...
																					<div class="elementor-column-wrap elementor-element-populated">
																						<div class="elementor-widget-wrap">
																							<div class="elementor-element elementor-element-4d8d7bc5 elementor-widget elementor-widget-image" data-id="4d8d7bc5" data-element_type="widget" data-widget_type="image.default">
																								<div class="elementor-widget-container">
																									<div class="elementor-image">
																										<img src="{{asset('fxipro_v2/iqoption1.jpg')}}" class="attachment-large size-large" alt="" loading="lazy" width="200" height="100">
																									</div>
																								</div>
																							</div>
																						</div>
																					...
																					<div class="elementor-column-wrap elementor-element-populated">
																						<div class="elementor-widget-wrap">
																							<div class="elementor-element elementor-element-2ec6cab5 elementor-widget elementor-widget-image" data-id="2ec6cab5" data-element_type="widget" data-widget_type="image.default">
																								<div class="elementor-widget-container">
																									<div class="elementor-image">
																										<img src="{{asset('fxipro_v2/olymptrade2.jpg')}}" class="attachment-large size-large" alt="" loading="lazy" width="200" height="100">
																									</div>
																								</div>
																							</div>
																						</div>
																					...
																					<div class="elementor-column-wrap elementor-element-populated">
																						<div class="elementor-widget-wrap">
																							<div class="elementor-element elementor-element-28b0b664 elementor-widget elementor-widget-image" data-id="28b0b664" data-element_type="widget" data-widget_type="image.default">
																								<div class="elementor-widget-container">
																									<div class="elementor-image">
																										<img src="{{asset('fxipro_v2/expertoption6.jpg')}}" class="attachment-large size-large" alt="" loading="lazy" width="200" height="100">
																									</div>
																								</div>
																							</div>
																						</div>
																					...
																					<div class="elementor-column-wrap elementor-element-populated">
																						<div class="elementor-widget-wrap">
																							<div class="elementor-element elementor-element-1065987d elementor-widget elementor-widget-image" data-id="1065987d" data-element_type="widget" data-widget_type="image.default">
																								<div class="elementor-widget-container">
																									<div class="elementor-image">
																										<img src="{{asset('fxipro_v2/binomo3.jpg')}}" class="attachment-large size-large" alt="" loading="lazy" width="200" height="100">
																									</div>
																								</div>
																							</div>
																						</div>
	...
	<link rel="stylesheet" id="premium-addons-css" href="{{asset('fxipro_v2/premium-addons_002.css')}}" media="all">
	...
	<script src="{{asset('fxipro_v2/animated-text.js')}}" id="animated-text-js"></script>
