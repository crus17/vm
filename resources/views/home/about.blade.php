...
<link rel="stylesheet" id="happy-elementor-addons-156-css" href="{{asset('main/happy-1564814.css')}}" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-7-css" href="{{asset('main/happy-74814.css')}}" media="all">
...
<link rel="stylesheet" id="elementor-post-156-css" href="{{asset('main/post-156.css')}}" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-1085-css" href="{{asset('main/happy-10854814.css')}}" media="all">
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
										<img src="{{asset('main/online-trade-0.jpg')}}" class="attachment-full size-full" alt="" loading="lazy" srcset="{{asset('main/online-trade-0.jpg')}} 565w, {{asset('main/online-trade-0.jpg')}} 300w" sizes="(max-width: 565px) 100vw, 565px" width="565" height="367">											</div>
				</div>
				</div>
						</div>
					</div>
