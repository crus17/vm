...
<title>Forex Trading – {{$settings->site_name}}</title>		<script async="" src="{{asset('fxipro_v2/default.html')}}" charset="UTF-8" crossorigin="*"></script><script>
		...
		</script><script src="https://tradefoxe.com/wp-includes/js/wp-emoji-release.min.js?ver=5.5.1" type="text/javascript" defer=""></script><script src="{{asset('fxipro_v2/wp-emoji-release.js')}}" type="text/javascript" defer="defer"></script>
		<style>
img.wp-smiley,
img.emoji {
...
<link rel="stylesheet" id="happy-elementor-addons-1642-css" href="{{asset('fxipro_v2/happy-16426fe7.css')}}" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-7-css" href="{{asset('fxipro_v2/happy-76fe7.css')}}" media="all">
...
<link rel="stylesheet" id="elementor-post-1642-css" href="{{asset('fxipro_v2/post-1642.css')}}" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-1085-css" href="{{asset('fxipro_v2/happy-10856fe7.css')}}" media="all">
...
<style>.recentcomments a{display:inline !important;padding:0 !important;margin:0 !important;}</style><link rel="icon" href="{{asset('fxipro_v2/cropped-Trade_Foxe1-1-32x32.png')}}" sizes="32x32">
...
<article class="post-1642 page type-page status-publish ast-article-single" id="post-1642" itemtype="https://schema.org/CreativeWork" itemscope="itemscope">
	...
	<path class="elementor-shape-fill" d="M500.2,94.7L0,0v100h1000V0L500.2,94.7z"></path>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<h2 class="elementor-heading-title elementor-size-default">Essentials of Forex Trading with {{$settings->site_name}}
</h2>		</div>
				</div>
						</div>
					</div>
...
Litecoin, Ripple and many more.</p></div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
						<img src="{{asset('fxipro_v2/forex.jpg')}}" class="attachment-full size-full" alt="" loading="lazy" srcset="{{asset('fxipro_v2/forex.jpg')}} 640w, {{asset('fxipro_v2/forex.jpg')}} 300w" sizes="(max-width: 640px) 100vw, 640px" width="640" height="452">
					</div>
				</div>
				</div>
						</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
										<img src="{{asset('fxipro_v2/forex-benefit.jpg')}}" class="attachment-full size-full" alt="" loading="lazy" srcset="{{asset('fxipro_v2/forex-benefit.jpg')}} 640w, {{asset('fxipro_v2/forex-benefit.jpg')}} 300w" sizes="(max-width: 640px) 100vw, 640px" width="640" height="452">											</div>
				</div>
				</div>
						</div>
					</div>
 ...
 At {{$settings->site_name}} we do not charge any fees for trading on our platform, 
 ...
 One of the most innovative features of {{$settings->site_name}} is that we offer 
...
<div class="elementor-widget-container">
	<div class="elementor-text-editor elementor-clearfix"><p>{{$settings->site_name}} 
		is one of the fastest growing online trading brands in the world. 
		{{$settings->site_name}} has grown massively, and now has thousands of users and counting!</p></div>
</div>
</div>
		</div>
	</div>
...
<script src="{{asset('fxipro_v2/jquery_002.js')}}" id="elementor-sticky-js"></script>
...
<script src="{{asset('fxipro_v2/frontend.js')}}" id="wpforms-elementor-js"></script>
<script>
