...
<title>Forex Trading – {{$settings->site_name}}</title>		
...
<link rel="stylesheet" id="happy-elementor-addons-1642-css" href="{{asset('main/happy-16426fe7.css')}}" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-7-css" href="{{asset('main/happy-76fe7.css')}}" media="all">
...
<link rel="stylesheet" id="elementor-post-1642-css" href="{{asset('main/post-1642.css')}}" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-1085-css" href="{{asset('main/happy-10856fe7.css')}}" media="all">
...
<style>.recentcomments a{display:inline !important;padding:0 !important;margin:0 !important;}</style><link rel="icon" href="{{asset('main/cropped-Trade_Foxe1-1-32x32.png')}}" sizes="32x32">
	...
	<div class="main-header-bar">
		...
		<div class="site-branding">
			<div class="ast-site-identity" itemtype="https://schema.org/Organization" itemscope="itemscope">
				<span class="site-logo-img"><a href="\" class="custom-logo-link" rel="home"><img src="{{asset('main/logo-white.png')}}" class="custom-logo" alt="{{$settings->site_name}}" srcset="" sizes="(max-width: 187px) 100vw, 187px" width="187" height="62"></a></span>			</div>
		</div>
...
Litecoin, Ripple and many more.</p></div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
						<img src="{{asset('main/forex.jpg')}}" class="attachment-full size-full" alt="" loading="lazy" srcset="{{asset('main/forex.jpg')}} 640w, {{asset('main/forex.jpg')}} 300w" sizes="(max-width: 640px) 100vw, 640px" width="640" height="452">
					</div>
				</div>
				</div>
						</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
										<img src="{{asset('main/forex-benefit.jpg')}}" class="attachment-full size-full" alt="" loading="lazy" srcset="{{asset('main/forex-benefit.jpg')}} 640w, {{asset('main/forex-benefit.jpg')}} 300w" sizes="(max-width: 640px) 100vw, 640px" width="640" height="452">											</div>
				</div>
				</div>
						</div>
					</div>
...
<div class="elementor-widget-container">
	<div class="elementor-image">
						<img src="{{asset('main/logo-white.png')}}" title="1587368802185" alt="1587368802185" width="220px;">											</div>
</div>
</div>
