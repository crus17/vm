...
<head>       
    ...
    <!-- favicon & bookmark -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144"  href="{{ asset('ultracry/images/bookmark.png') }}" type="image/x-icon" />
    <link rel="shortcut icon" href="{{ asset('ultracry/images/favicon.png') }}" type="image/x-icon" />
    <!-- Font Family -->
    ...
    <!-- Stylesheets Start -->
    <link rel="stylesheet" href="{{ asset ('ultracry/css/fontawesome.min.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset ('ultracry/css/bootstrap.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset ('ultracry/css/animate.css')}}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset ('ultracry/css/owl.carousel.min.css')}}" type="text/css"/>
    <!--<link rel="stylesheet" href="{{ asset ('ultracry/style_v2.css')}}" type="text/css"/>-->
    <!--<link rel="stylesheet" href="{{ asset ('ultracry/style.css')}}" type="text/css"/>-->
    <link rel="stylesheet" href="https://sacredthemes.net/coinpool/style.css" type="text/css"/>
    <link rel="stylesheet" href="{{ asset ('ultracry/css/responsive.css')}}" type="text/css"/>
    
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
	<link rel="icon" href="{{asset('ultracry/logo.png') }}">
     <!-- Stylesheets End -->
     
    <!--[if lt IE 9]><script src="https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.js"></script><![endif]-->
    <!--[if lt IE 9]><script src="js/respond.js"></script><![endif]-->
   <link rel="stylesheet" href="{{ asset ('ultracry/alert/fake-notification-min.css')}}"/>
   <style>
...
<body>
    ...
    <div class="wrapper" id="top">
	   ...
	   <header>   
				...
				<div class="row"> 
                    <div class="col-sm-6 col-md-4 logo">
                        <a href="#" title={{$settings->site_name}} >
                            <img class="light" src="{{ asset ('ultracry/logo-3.png') }}" width="120" alt="{{$settings->site_name}} ">
                            <img class="dark" src="{{ asset ('ultracry/logo-1.png') }}" width="120" alt="{{$settings->site_name}} ">
                        </a>
                    </div>
        ...
        <div class="midd-container">
    	   ...
    	   <!--***********-->
    	   <div class="hero-main diamond-layout white-sec" style="background:url({{ asset('ultracry/images/banner-4.jpg')}}">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-sm-12 col-md-6">
                            <h1>The Future of Investment <span>Easy and Secured!</span></h1>
                            <p class="lead">{{$settings->site_name}} offers investors a convenient way to incorporate a rapidly growing digital asset into their portfolios.</p>
                            <div class="hero-btns">
                        ...
                        <div class="col-sm-12 col-md-6" data-wow-delay="0.5s">
                            ...
                            <!--<div class="mobile-visible text-center">
                                <img src="{{ asset('ultracry/images/diamond-animation-mobile.png')}}"" alt="">
                            </div>-->
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row flex-row-reverse align-items-center">
                            ...
                            <div style="margin-top:100px;" class="col-lg-6 col-md-12">
                                ...
                                <h5>
                                    {{$settings->site_name}} provides you with a wide range of platforms and service options best tailored to ensure high returns on investment. Whether you’re a self-directed investor, or trading through our desk, we offer multiple solutions.
                                </h5>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="benefit-box text-center">
                                    <div class="benefit-icon">
                                        <img src="{{asset('ultracry/images/benefit-icon-1.png') }}" alt="Safe and Secure">
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="benefit-box text-center">
                                    <div class="benefit-icon">
                                        <img src="{{asset('ultracry/images/benefit-icon-2.png') }}" alt="Instant Exchange">
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="benefit-box text-center">
                                    <div class="benefit-icon">
                                        <img src="{{asset('ultracry/images/benefit-icon-4.png') }}" alt="Mobile Apps">
                                    </div>
                                    <div class="text">
                                        <h4>Mobile Apps</h4>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="counter" >
                                    <div class="counter-icon">
                                        <img src="{{ asset('ultracry/images/transactions-icon.png') }}" alt="" />
                                    </div>
                            ...
                            <div class="col">
                                <div class="counter">
                                    <div class="counter-icon">
                                        <img src="{{ asset('ultracry/images/support-icon.png') }}" alt="" />
                                    </div>
                            ...
                            <div class="col">
                                <div class="counter">
                                    <div class="counter-icon">
                                        <img src="{{ asset('ultracry/images/wallets-icon.png') }}" alt="" />
                                    </div>
                            ...
                            <div class="col">
                                <div class="counter">
                                    <div class="counter-icon">
                                        <img src="{{ asset('ultracry/images/countries-icon.png') }}" alt="" />
                                    </div>
                        ...
                        <div class="row align-items-center flex-row-reverse">
                            <div class="col-lg-5">
                                <div class="iphone-img">
                                    <img src="{{asset('ultracry/images/mercury-iphone-img.png') }}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <h2 class="section-heading">Mobile App Coming Soon!</h2>
                                <p>{{$settings->site_name}} is a top tier bitcoin investment platform accessible to everyone. {{$settings->site_name}} is a modular Bitcoin full-node microservices API server architecture and utilities toolkit are built to be scalable</p>
                                <p>{{$settings->site_name}} is run by self-proclaimed Experts and Bitcoin Maximalists and it shows as one of the top bitcoin investment sites with focus on privacy, security, and enabling users to maintain full custody of their Bitcoin.</p>
                                <div class="button-wrapper">
                                    <a href="#" class="apple-btn">
                                        <img src="{{asset('ultracry/images/app-store-btn.png') }}" alt="">
                                    </a>
                                    <a href="#" class="google-btn">
                                        <img src="{{ asset ('ultracry/images/google-play-btn.png') }}" alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="team-box">
                                    <div class="team-img">
                                        <img src="{{asset('ultracry/images/team-9.jpg')}}" alt="">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="team-box">
                                    <div class="team-img">
                                        <img src="{{ asset ('ultracry/images/team-10.jpg') }}" alt="">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="team-box">
                                    <div class="team-img">
                                        <img src="{{ asset ('ultracry/images/team-12.jpg') }}" alt="">
                                    </div>
                                    <div class="text">
                                        <h4>Saru M</h4>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="team-box">
                                    <div class="team-img">
                                        <img src="{{ asset ('ultracry/images/team-11.jpg') }}" alt="">
                                    </div>
                                    <div class="text">
                                        <h4>Herv N</h4>
                ...
                <div class="brand-logo-slider c-l p-tb white-sec">
                    <div class="container">
                        ...
                        <div class="brand-logos owl-carousel">
                            <div class="item"><img src="{{ asset ('ultracry/images/trustwallet.png')}}" alt="Trust Wallet" /></div>
                            <div class="item"><img src="{{ asset ('ultracry/images/luno.png')}}" alt="Luno" /></div>
                            <div class="item"><img src="{{ asset ('ultracry/images/paxful.png')}}" alt="Paxful" /></div>
                            <div class="item"><img src="{{ asset ('ultracry/images/binance.png')}}" alt="Binance" /></div>
                            <div class="item"><img src="{{ asset ('ultracry/images/coinmama.png')}}" alt="Coin Mama" /></div>
                        </div>
                    </div>
                </div>
                <!-- Brand logo end -->
                    ...
                    <div class="row">
                        <div class="col-md-4 footer-box-1">
                            <div class="footer-logo">
                                <a href="#" title=""><img src="{{ asset ('ultracry/logo-3.png') }}" width="120" alt="Cp Silver"></a>
                            </div>
    ...
    <script type="text/javascript" src="{{ asset ('ultracry/alert/js/jquery.fake-notification.min.js')}}"></script>
	<script>
	...
	<div id="capitol-callback">
	  ...
	  <a href="https://api.whatsapp.com/send?phone=+447883181291&text= Hello {{$settings->site_name}} " id="WhatsAppBtnDesktop" target="_blank" class="main-button" lang="en">
    ...
    <script src="{{ asset ('ultracry/js/jquery.min.js')}}"></script>
    <script src="{{ asset ('ultracry/js/bootstrap.min.js')}}"></script>
    <script src="{{ asset ('ultracry/js/onpagescroll.js')}}"></script>
    <script src="{{ asset ('ultracry/js/wow.min.js')}}"></script>
    <script src="{{ asset ('ultracry/js/jquery.countdown.js')}}"></script>
    <script src="{{ asset ('ultracry/js/owl.carousel.js')}}"></script>
    
    
    <script src="{{ asset ('ultracry/js/Chart.js')}} "></script>
    <script src="{{ asset ('ultracry/js/chart-function.js')}} "></script>
    <script src="{{ asset ('ultracry/js/script.js')}} "></script>
    <script src="{{ asset ('ultracry/js/particles.js')}} "></script>
    <script src="{{ asset ('ultracry/js/gold-app.js')}} "></script>
