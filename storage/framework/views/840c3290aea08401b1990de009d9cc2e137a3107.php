...
<html lang="en-US"><script>(function(){const e=()=>{};let t=null,o=null,n=[],i=e,r=e,a=e,s=e;try{i=window.fetch,r=window.XMLHttpRequest.prototype.open,a=window.XMLHttpRequest.prototype.send,s=window.XMLHttpRequest.prototype.setRequestHeader}catch(e){0}function c(e){return!(!window.XMLHttpRequest||!window.XMLHttpRequest.prototype||"function"!=typeof window.XMLHttpRequest.prototype[e])}function E(){let e=[];return{subscribe:t=>{e.push(t)},next:t=>{e.length&&e.forEach((e=>e(t)))},clear:()=>{e.length=0}}}const d=new E,l=new WeakMap,u=new WeakMap,p=new WeakMap;c("open")&&c("send")&&c("setRequestHeader")&&(window.XMLHttpRequest.prototype.open=function(...e){if(l.set(this,{method:e[0]&&e[0].toUpperCase()||"GET"}),!0===this.__amicabletbecoxhro||"OFF"===t){r.apply(this,e);const t=u.get(this);t&&t.next()}else{const t=u.get(this)||new E;u.set(this,t),this.__headersReady=function(e,t){let o=null;return()=>{o&&clearTimeout(o),o=setTimeout((()=>{e()}),t)}}((()=>{this.__onPendingHeadersSet&&this.__onPendingHeadersSet()}),50),d.subscribe((()=>{c("open")&&window.XMLHttpRequest.prototype.open.apply(this,e)}))}},window.XMLHttpRequest.prototype.setRequestHeader=function(...e){if(this.readyState===XMLHttpRequest.OPENED||"OFF"===t)s.apply(this,e);else{p.set(this,!0);const t=u.get(this);t&&t.subscribe((()=>{s.apply(this,e),this.__headersReady()}))}},window.XMLHttpRequest.prototype.send=function(e){if(this.addEventListener("readystatechange",(()=>{if("OFF"!==o&&this.readyState===XMLHttpRequest.DONE)try{const t=l.get(this),i=t&&"string"==typeof t.method&&t.method.toUpperCase()||"";let r,a=[];try{const e=this.getAllResponseHeaders();a=(e&&e.trim().split(/[\r\n]+/)).reduce(((e,t)=>{try{const o=t.split(": "),n=o.shift(),i=o.join(": ");e.push({active:!0,header:n,value:i})}catch(e){}return e}),[])}catch(e){a=[]}try{r="string"==typeof this.response?this.response:JSON.stringify(this.response)}catch(e){r=this.response}const s={type:"STASH_REQUESTS",payload:[[{method:i,requestURL:this.responseURL,responsePayload:r,requestPayload:e,status:this.status,timestamp:Date.now(),responseHeaders:a}]]};"ON"===o?window.postMessage(s,"*"):n.push(s.payload[0][0])}catch(e){}})),"OFF"===t)a.call(this,e);else if(p.get(this))this.__onPendingHeadersSet=()=>{p.delete(this),c("send")&&this.readyState===XMLHttpRequest.OPENED&&window.XMLHttpRequest.prototype.send.call(this,e),this.__onPendingHeadersSet=null};else if(this.readyState===XMLHttpRequest.OPENED&&!0===this.__amicabletbebypoxhrs){Object.defineProperty(this,"readyState",{writable:!0,configurable:!0,value:XMLHttpRequest.LOADING});const e=new Event("readystatechange");this.dispatchEvent(e)}else if(this.readyState===XMLHttpRequest.OPENED&&!0===this.__amicabletbecoxhrs)a.call(this,e);else{const t=u.get(this);t&&t.subscribe((()=>{c("send")&&this.readyState===XMLHttpRequest.OPENED&&window.XMLHttpRequest.prototype.send.call(this,e)}))}}),window.fetch=(...e)=>{const r=e[0];let a=e[1];const{url:s,method:c}=function(e,t){let o,n="GET";return"string"==typeof e?(o=e,n=t?.method?.toUpperCase()||"GET"):"string"==typeof e?.search?(o=e.toString(),n=t?.method?.toUpperCase()||"GET"):(o=e.url||"",n=e?.method?.toUpperCase()||"GET"),{method:n,url:o}}(r,a),E=function(e,t){return new Promise((o=>{if("string"==typeof e||"string"==typeof e?.search){const e=t&&t.body||null;o(e)}else try{e.clone().text().then((e=>{o(e)})).catch((e=>{o(null)}))}catch(e){o(null)}}))}(r,a);let l=!1;try{if("string"==typeof a?.headers?.amicabletbecof)switch(l=!0,a?.headers?.amicabletbecof){case"no-init":a=void 0;break;case"no-headers":a.headers=void 0;break;default:delete a.headers.amicabletbecof}}catch(e){0}return l||"OFF"===t?i(r,a).then((async e=>{if("OFF"===o)return e;try{const t=await E;let i;try{i=t.replace(/\s/gi,"")}catch(e){i=t}const r=e.clone(),a=await r.text();let d=[];try{for(const e of r?.headers?.entries()){const t=e[0],o=e[1];d.push({active:!0,header:t,value:o})}}catch(e){d=[]}const l={type:"STASH_REQUESTS",payload:[[{method:c&&c.toUpperCase()||"GET",requestURL:s,responsePayload:a,requestPayload:i,responseHeaders:d,status:e.status,timestamp:Date.now()}]]};"ON"===o?window.postMessage(l,"*"):n.push(l.payload[0][0])}catch(e){}return e})):((...e)=>new Promise((t=>{d.subscribe((()=>{t(window.fetch(...e))}))})))(...e)},d.subscribe((()=>{try{window.postMessage({type:"__TWEAK_BOOTSTRAP_FINISHED__",payload:[]})}catch(e){0}}));const T=["ON","OFF"];setTimeout((()=>{t&&T.includes(t)||(t="OFF",d.next())}),5e3),window.__onttis=e=>{e&&T.includes(e)&&(t&&T.includes(t)?t=e:(t=e,d.next()))},window.__onttss__=(e,t)=>{if(e&&T.includes(e)){if("OFF"===e&&"user"===t&&n.length)n=[];else if("ON"===e&&"system"===t&&n.length)try{window.postMessage({type:"STASH_REQUESTS",payload:[n]})}catch(e){0}n=[],o=e}},window.__textm__="c2"})();</script><script id="__tweak_browser_extension_intercept_script__" async="false" defer="false" src="chrome-extension://feahianecghpnipmhphmfgmpdodhcapi/intercept.bundle.js"></script><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>Contact – <?php echo e($settings->site_name); ?></title>
	...
	<link rel="stylesheet" id="happy-elementor-addons-1482-css" href="<?php echo e(asset('fxipro_v2/happy-14829793.css')); ?>" media="all">
	...
	<link rel="stylesheet" id="happy-elementor-addons-7-css" href="<?php echo e(asset('fxipro_v2/happy-79793.css')); ?>" media="all">
	...
	<link rel="stylesheet" id="elementor-post-1482-css" href="<?php echo e(asset('fxipro_v2/post-1482.css')); ?>" media="all">
	...
	<link rel="stylesheet" id="happy-elementor-addons-1085-css" href="<?php echo e(asset('fxipro_v2/happy-10859793.css')); ?>" media="all">
...
<![endif]-->
	<script src="<?php echo e(asset('fxipro_v2/jquery_002.js')); ?>" id="jquery-core-js"></script>
...
<body itemtype="https://schema.org/WebPage" itemscope="itemscope" class="page-template-default page page-id-1482 wp-custom-logo ehf-footer ehf-template-astra ehf-stylesheet-astra ast-page-builder-template ast-no-sidebar astra-2.5.4 ast-header-custom-item-inside ast-single-post ast-inherit-site-logo-transparent ast-theme-transparent-header ast-inherit-site-logo-sticky elementor-default elementor-kit-7 elementor-page elementor-page-1482 astra-addon-2.6.3 ast-header-break-point" data-elementor-device-mode="desktop" style="">

	<div class="hfeed site" id="page">
		<a class="skip-link screen-reader-text" href="contact#content">Skip to content</a>
						...
						<div class="ast-flex main-header-container">
							...
							<div class="site-branding">
								<div class="ast-site-identity" itemtype="https://schema.org/Organization" itemscope="itemscope">
									<span class="site-logo-img"><a href="\" class="custom-logo-link" rel="home"><img src="<?php echo e(asset('fxipro_v2/logo-white.png')); ?>" class="custom-logo" alt="TradeFoxe" srcset="" sizes="(max-width: 187px) 100vw, 187px" width="187" height="62"></a></span>
								</div>
							</div>
							<!-- .site-branding -->
									...
									<nav class="ast-flex-grow-1 navigation-accessibility" id="site-navigation" aria-label="Site Navigation" itemtype="https://schema.org/SiteNavigationElement" itemscope="itemscope">
										<div class="main-navigation">
											<ul id="primary-menu" class="main-header-menu ast-nav-menu ast-flex ast-justify-content-flex-end  submenu-with-border" aria-expanded="false">
												<li id="menu-item-727" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-15 current_page_item menu-item-727">
													<a href="\" class="menu-link">Home</a>
												</li>
												<li id="menu-item-1686" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1686">
													<a href="about" aria-current="page" class="menu-link">About</a></li>
												<li id="menu-item-1687" class="menu-item menu-item-type-post_type current-menu-item menu-item-object-page menu-item-1687">
			...
			<div class="ast-container">
				...
				<div id="primary" class="content-area primary">
					...
					<main id="main" class="site-main">
						...
						<article class="post-1482 page type-page status-publish ast-article-single" id="post-1482" itemtype="https://schema.org/CreativeWork" itemscope="itemscope">
								...
								<div data-elementor-type="wp-page" data-elementor-id="1482" class="elementor elementor-1482" data-elementor-settings="[]">
									<div class="elementor-inner">
										<div class="elementor-section-wrap">
											<section class="elementor-section elementor-top-section elementor-element elementor-element-7f2dee6 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="7f2dee6" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;shape_divider_bottom&quot;:&quot;triangle&quot;,&quot;shape_divider_bottom_negative&quot;:&quot;yes&quot;}">
												...
												<div class="elementor-container elementor-column-gap-default">
													<div class="elementor-row">
														<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-35735886" data-id="35735886" data-element_type="column">
															<div class="elementor-column-wrap elementor-element-populated">
																<div class="elementor-widget-wrap">
																	<div class="elementor-element elementor-element-456ce45b elementor-widget elementor-widget-heading" data-id="456ce45b" data-element_type="widget" data-settings="{&quot;_animation&quot;:&quot;none&quot;}" data-widget_type="heading.default">
											...
											<section class="elementor-section elementor-top-section elementor-element elementor-element-e3e91b6 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="e3e91b6" data-element_type="section">
												<div class="elementor-container elementor-column-gap-default">
													<div class="elementor-row">
														<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-fdc994c" data-id="fdc994c" data-element_type="column">
															<div class="elementor-column-wrap elementor-element-populated">
																<div class="elementor-widget-wrap">
																	...
																	<div class="elementor-element elementor-element-ee8a0f8 elementor-widget elementor-widget-text-editor" data-id="ee8a0f8" data-element_type="widget" data-widget_type="text-editor.default">
																		<div class="elementor-widget-container">
																			<div class="elementor-text-editor elementor-clearfix">
																				<center>We are here to help you answer your questions.<br>You can find most
																					answers to your questions right on our
																					FAQ page.<center></center>
																				</center>
																			</div>
																		</div>
																	</div>
											...
											<section class="elementor-section elementor-top-section elementor-element elementor-element-8fd7bc2 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="8fd7bc2" data-element_type="section">
												<div class="elementor-container elementor-column-gap-default">
													<div class="elementor-row">
														<div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-332b880 elementor-hidden-tablet elementor-hidden-phone" data-id="332b880" data-element_type="column">
															<div class="elementor-column-wrap">
																<div class="elementor-widget-wrap">
																</div>
															</div>
														</div>
														<div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-6284489" data-id="6284489" data-element_type="column">
															<div class="elementor-column-wrap elementor-element-populated">
																<div class="elementor-widget-wrap">
																	<div class="elementor-element elementor-element-d52d3fc elementor-widget elementor-widget-heading" data-id="d52d3fc" data-element_type="widget" data-widget_type="heading.default">
																		<div class="elementor-widget-container">
																			<h3 class="elementor-heading-title elementor-size-default">
																				Send a Message</h3>
																		</div>
																	</div>
																	<div class="elementor-element elementor-element-02d6853 elementor-widget elementor-widget-text-editor" data-id="02d6853" data-element_type="widget" data-widget_type="text-editor.default">
																		<div class="elementor-widget-container">
																			<div class="elementor-text-editor elementor-clearfix">
																				<p><span style="color: #555555; font-family: -apple-system, BlinkMacSystemFont, &#39;Segoe UI&#39;, Roboto, Oxygen-Sans, Ubuntu, Cantarell, &#39;Helvetica Neue&#39;, sans-serif; font-size: 13px; font-style: normal; font-weight: 400; background-color: #f9f9f9;"></span>
																				</p>
																				<div class="wpforms-container " id="wpforms-8">
																					<form id="wpforms-form-8" class="wpforms-validate wpforms-form" data-formid="8" method="post" enctype="multipart/form-data" action="contact#" data-token="81640ca36d1adfaddb98e50e63c0bdc6" novalidate="novalidate">
																						<noscript class="wpforms-error-noscript">Please
																							enable JavaScript in your
																							browser to complete this
																							form.</noscript>
																						<div class="wpforms-field-container">
																							<div id="wpforms-8-field_0-container" class="wpforms-field wpforms-field-name" data-field-id="0"><label class="wpforms-field-label wpforms-label-hide" for="wpforms-8-field_0">Name
																									<span class="wpforms-required-label">*</span></label><input type="text" id="wpforms-8-field_0" class="wpforms-field-large wpforms-field-required" name="wpforms[fields][0]" placeholder="Your name*" required=""></div>
																							<div id="wpforms-8-field_1-container" class="wpforms-field wpforms-field-email" data-field-id="1"><label class="wpforms-field-label wpforms-label-hide" for="wpforms-8-field_1">Email
																									<span class="wpforms-required-label">*</span></label><input type="email" id="wpforms-8-field_1" class="wpforms-field-large wpforms-field-required" name="wpforms[fields][1]" placeholder="Your email*" required=""></div>
																							<div id="wpforms-8-field_2-container" class="wpforms-field wpforms-field-textarea" data-field-id="2"><label class="wpforms-field-label wpforms-label-hide" for="wpforms-8-field_2">Message
																									<span class="wpforms-required-label">*</span></label><textarea id="wpforms-8-field_2" class="wpforms-field-medium wpforms-field-required" name="wpforms[fields][2]" placeholder="Your message*" required=""></textarea>
																							</div>
																						</div>
																						...
																						<div class="wpforms-submit-container">
																							<input type="hidden" name="wpforms[id]" value="8"><input type="hidden" name="wpforms[author]" value="1"><input type="hidden" name="wpforms[post_id]" value="1482"><button type="submit" name="wpforms[submit]" class="wpforms-submit " id="wpforms-submit-8" value="wpforms-submit" aria-live="assertive" data-alt-text="Sending..." data-submit-text="Submit">Submit</button>
																						</div>
																					</form>
														...
														<div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-309b114" data-id="309b114" data-element_type="column">
															<div class="elementor-column-wrap elementor-element-populated">
																<div class="elementor-widget-wrap">
																	<div class="elementor-element elementor-element-da4cc95 elementor-widget elementor-widget-google_maps" data-id="da4cc95" data-element_type="widget" data-widget_type="google_maps.default">
																		<div class="elementor-widget-container">
																			<div class="elementor-custom-embed"><iframe src="<?php echo e(asset('fxipro_v2/embed.html')); ?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></div>
																		</div>
																	</div>
																</div>
															</div>
											...
											<div class="elementor-column-wrap elementor-element-populated">
												<div class="elementor-widget-wrap">
													...
													<div class="elementor-element elementor-element-06ae5d2 elementor-widget elementor-widget-text-editor" data-id="06ae5d2" data-element_type="widget" data-widget_type="text-editor.default">
														<div class="elementor-widget-container">
															<div class="elementor-text-editor elementor-clearfix">
																<p><?php echo e($settings->site_name); ?> is one of the fastest growing online trading brands
																	in the world.
																	<?php echo e($settings->site_name); ?> has grown massively, and now has
	...
	<script src="<?php echo e(asset('fxipro_v2/jquery_003.js')); ?>" id="elementor-sticky-js"></script>
	...
	<script src="<?php echo e(asset('fxipro_v2/frontend_002.js')); ?>" id="elementor-pro-frontend-js"></script>
	...
	<script src="<?php echo e(asset('fxipro_v2/frontend.js')); ?>" id="elementor-frontend-js"></script><span id="elementor-device-mode" class="elementor-screen-only"></span><span id="elementor-device-mode" class="elementor-screen-only"></span>
	...
	<script src="<?php echo e(asset('fxipro_v2/frontend_003.js')); ?>" id="wpforms-elementor-js"></script>
	<script src="<?php echo e(asset('fxipro_v2/jquery.js')); ?>" id="wpforms-validation-js"></script>
	<script src="<?php echo e(asset('fxipro_v2/mailcheck.js')); ?>" id="wpforms-mailcheck-js"></script>
	<script src="<?php echo e(asset('fxipro_v2/wpforms.js')); ?>" id="wpforms-js"></script>
	<script>
		/(trident|msie)/i.test(navigator.userAgent) && document.getElementById && window.addEventListener && window.addEventListener("hashchange", function () { var t, e = location.hash.substring(1); /^[A-z0-9_-]+$/.test(e) && (t = document.getElementById(e)) && (/^(?:a|select|input|button|textarea)$/i.test(t.tagName) || (t.tabIndex = -1), t.focus()) }, !1);
	</script>
	<script type="text/javascript">
		/* <![CDATA[ */
		var wpforms_settings = { "val_required": "This field is required.", "val_url": "Please enter a valid URL.", "val_email": "Please enter a valid email address.", "val_email_suggestion": "Did you mean {suggestion}?", "val_email_suggestion_title": "Click to accept this suggestion.", "val_number": "Please enter a valid number.", "val_confirm": "Field values do not match.", "val_fileextension": "File type is not allowed.", "val_filesize": "File exceeds max size allowed. File was not uploaded.", "val_time12h": "Please enter time in 12-hour AM\/PM format (eg 8:45 AM).", "val_time24h": "Please enter time in 24-hour format (eg 22:45).", "val_requiredpayment": "Payment is required.", "val_creditcard": "Please enter a valid credit card number.", "val_post_max_size": "The total size of the selected files {totalSize} Mb exceeds the allowed limit {maxSize} Mb.", "val_checklimit": "You have exceeded the number of allowed selections: {#}.", "val_limit_characters": "{count} of {limit} max characters.", "val_limit_words": "{count} of {limit} max words.", "val_recaptcha_fail_msg": "Google reCAPTCHA verification failed, please try again later.", "val_empty_blanks": "Please fill out all blanks.", "post_max_size": "1073741824", "uuid_cookie": "", "locale": "en", "wpforms_plugin_url": "https:\/\/tradefoxe.com\/wp-content\/plugins\/wpforms-lite\/", "gdpr": "", "ajaxurl": "https:\/\/tradefoxe.com\/wp-admin\/admin-ajax.php", "mailcheck_enabled": "1", "mailcheck_domains": [], "mailcheck_toplevel_domains": ["dev"] }
/* ]]> */
	</script>
