																					...
																					<div class="swiper-wrapper elementor-slides" style="transition-duration: 500ms; transform: translate3d(-4047px, 0px, 0px);"><div class="elementor-repeater-item-fa61318 swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="0" style="width: 1349px;">
																							...
																							<div class="elementor-background-overlay">
																								...
																								<div class="swiper-slide-contents" style="display: none;">
																									...
																									<div class="elementor-slide-description">
																										<?php echo e($settings->site_name); ?> allows
																										you to Trade
																										Major Pairs with
																										Minor Fees
																										<br>and achieve
																							...
																							<div class="elementor-background-overlay">
																								...
																								<div class="swiper-slide-contents" style="display: none;">
																									...
																									<div class="elementor-slide-description">
																										<?php echo e($settings->site_name); ?> offers
																										you professional
																										trading tools
																										and analysis
																										<br>that gives
																	...
																	<div class="elementor-element elementor-element-0f955a1 elementor-widget elementor-widget-ha-animated-text happy-addon ha-animated-text happy-addon-pro" data-id="0f955a1" data-element_type="widget" data-settings="{&quot;animation_delay&quot;:1500}" data-widget_type="ha-animated-text.default">
																		<div class="elementor-widget-container">
																			<h2 class="ha-animated-text-wrap cd-headline letters rotate-2 ha-animated-has-before-text" data-animation-delay="1500"><span class="ha-animated-before-text">WELCOME
																					TO</span><br><span style="color:#801E87"> <?php echo e($settings->site_name); ?></span></h2>
																		</div>
																	</div>
																			...
																			<div class="uael-module-content uael-dual-color-heading">
																				<h2>
																					<span class="uael-before-heading"><span class="elementor-inline-editing uael-dual-heading-text uael-first-text" data-elementor-setting-key="before_heading_text" data-elementor-inline-editing-toolbar="basic">Why
																							Choose </span></span><span class="uael-adv-heading-stack"><span class="elementor-inline-editing uael-dual-heading-text uael-highlight-text" data-elementor-setting-key="second_heading_text" data-elementor-inline-editing-toolbar="basic"><?php echo e($settings->site_name); ?></span></span>
																				</h2>
																			</div>
																		</div>
																	</div>
																					...
																					<div class="feature-item feature-p">
																						...
																						<div class="feature-text">
																							...
																							<p>Your trading is managed by a
																								group of <?php echo e($settings->site_name); ?> experts</p>
																						</div>
																					</div>
																				</div>
																			</center>
																				...
																				<div class="elementor-price-table">
																					<div class="elementor-price-table__header">
																						<h3 class="elementor-price-table__heading">
																							<?php echo e($plan->name); ?></h3>

																						<span class="elementor-price-table__subheading">
																							Min. Possible deposit: <?php echo e($settings->currency); ?><?php echo e(number_format($plan->min_price, 0, '.', ',')); ?>

																							<br>Max. Possible deposit: <?php echo e($settings->currency); ?><?php echo e(number_format($plan->max_price, 0, '.', ',')); ?>

																						</span>
																					</div>

																					<div class="elementor-price-table__price">
																						<span class="elementor-price-table__currency elementor-currency--before"><?php echo e($settings->currency); ?></span>
																						<span class="elementor-price-table__integer-part" style="font-size:48px;"><?php echo e(number_format($plan->min_price, 0, '.', ',')); ?>+</span>

																						<span class="elementor-price-table__period elementor-typo-excluded">
																							Returns in <?php echo e($plan->expiration); ?>
																					...
																					<ul class="elementor-price-table__features-list">
																						<li class="elementor-repeater-item-91f617b">
																							<div class="elementor-price-table__feature-inner">
																								...
																								<span>
																									At least 
																									<?php echo e($settings->currency); ?><?php echo e(number_format($plan->minr, 0, '.', ',')); ?>
																						...
																						<li class="elementor-repeater-item-d6e2933">
																							<div class="elementor-price-table__feature-inner">
																								<img src="<?php echo e(asset('main/star.png')); ?>" aria-hidden="true">
																								<?php if($plan->increment_type === "Percentage"): ?>
																								<span><?php echo e(number_format($plan->increment_amount, 0, '.', ',')); ?>% <?php echo e($plan->increment_interval); ?> return</span>
																								<?php else: ?>
																								<span><?php echo e($settings->currency); ?><?php echo e(number_format($plan->increment_amount, 0, '.', ',')); ?> <?php echo e($plan->increment_interval); ?> return</span>
																								<?php endif; ?>
																							</div>
																						</li>
																						<li class="elementor-repeater-item-4e4d4c1">
																							<div class="elementor-price-table__feature-inner">
																								...
																								<span>
																									Bonus: <?php echo e($settings->currency); ?><?php echo e(number_format($plan->gift, 0, '.', ',')); ?>
																				...
																				<div class="premium-testimonial-container">
																					...
																					<div class="premium-testimonial-content-wrapper">
																						...
																						<div class="premium-testimonial-text-wrapper">
																							<div>
																								<p>"
																								I will not praise <?php echo e($settings->site_name); ?> and convince someone that 
																						...
																						<div class="premium-testimonial-text-wrapper">
																							<div>
																								<p>"For years I was
																									...
																									week from the
																									comfort of my home
																									using <?php echo e($settings->site_name); ?>
																						...
																						<div class="premium-testimonial-text-wrapper">
																							<div>
																								<p>I'm happy to work
																									with the super
																									amazing
																									experts on <?php echo e($settings->site_name); ?>, I had a tough
																									time trading on my
																									own and I loosed a
																									lot of money, THANKS
																...
																<div class="elementor-column-wrap elementor-element-populated">
																	<div class="elementor-widget-wrap">
																		<div class="elementor-element elementor-element-4d8d7bc5 elementor-widget elementor-widget-image" data-id="4d8d7bc5" data-element_type="widget" data-widget_type="image.default">
																			<div class="elementor-widget-container">
																				<div class="elementor-image">
																					<img src="<?php echo e(asset ('home/images/binance.png')); ?>" class="attachment-large size-large" alt="Binance" loading="lazy" width="200" height="100">
																				</div>
																			</div>
																		</div>
																	</div>
																...
																<div class="elementor-column-wrap elementor-element-populated">
																	<div class="elementor-widget-wrap">
																		<div class="elementor-element elementor-element-4d8d7bc5 elementor-widget elementor-widget-image" data-id="4d8d7bc5" data-element_type="widget" data-widget_type="image.default">
																			<div class="elementor-widget-container">
																				<div class="elementor-image">
																					<img src="<?php echo e(asset ('home/images/coinbase.png')); ?>" class="attachment-large size-large" alt="coinbase" loading="lazy" width="200" height="100">
																				</div>
																			</div>
																		</div>
																	</div>
																...
																<div class="elementor-column-wrap elementor-element-populated">
																	<div class="elementor-widget-wrap">
																		<div class="elementor-element elementor-element-28b0b664 elementor-widget elementor-widget-image" data-id="28b0b664" data-element_type="widget" data-widget_type="image.default">
																			<div class="elementor-widget-container">
																				<div class="elementor-image">
																					<img src="<?php echo e(asset ('home/images/blockchain.png')); ?>" class="attachment-large size-large" alt="Coin Mama" loading="lazy" width="200" height="100">
																				</div>
																			</div>
																		</div>
																	</div>
																...
																<div class="elementor-column-wrap elementor-element-populated">
																	<div class="elementor-widget-wrap">
																		<div class="elementor-element elementor-element-1065987d elementor-widget elementor-widget-image" data-id="1065987d" data-element_type="widget" data-widget_type="image.default">
																			<div class="elementor-widget-container">
																				<div class="elementor-image">
																					<img src="<?php echo e(asset ('home/images/crypto.png')); ?>" class="attachment-large size-large" alt="crypto" loading="lazy" width="200" height="100">
																				</div>
																			</div>
																		</div>
																	</div>
