    ...
    <div class="panel panel-default" style="border:0px solid #fff;">
        ...
        <div class="panel panel-default" style="border:0px solid #fff;">
                ...
                <div id="contact_number" class="panel-collapse collapse">
                    ...
                    <div class="sign-up2">
                        <input type="text" name="contact_number" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" value="<?php echo e($settings->contact_number); ?>">
                    </div>
                </div>
            </div>
