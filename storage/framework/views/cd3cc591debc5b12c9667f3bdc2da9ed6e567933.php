...
<div class="row">
    <div class="col card bg-<?php echo e($bg); ?> shadow-lg p-4">
        ...
        <form method="post" autocomplete="off" action="<?php echo e(action('SomeController@savedeposit')); ?>" enctype="multipart/form-data">
                <h5 class="text-<?php echo e($text); ?>">Upload Payment proof after payment.</h5>
                <input type="file" name="proof" class="form-control col-lg-4 bg-<?php echo e($bg); ?> text-<?php echo e($text); ?>" required><br>
                
                <h5 class="text-<?php echo e($text); ?>">Amount Paid:</h5>
                <input type="number" value="<?php echo e($amount); ?>" placeholder="$ 0" name="amount" class="form-control col-lg-4 bg-<?php echo e($bg); ?> text-<?php echo e($text); ?>" required><br>
