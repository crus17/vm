...
<title>Stock Trading –  <?php echo e($settings->site_name); ?></title>
<script src="https://tradefoxe.com/wp-includes/js/wp-emoji-release.min.js?ver=5.5.1" type="text/javascript" defer=""></script><script src="<?php echo e(asset('fxipro_v2/wp-emoji-release.js')); ?>" type="text/javascript" defer="defer"></script>
<style>
	img.wp-smiley,
	img.emoji {
	...
	<link rel="stylesheet" id="astra-theme-css-css" href="<?php echo e(asset('fxipro_v2/style.css')); ?>" media="all">
...
<link rel="stylesheet" id="wp-block-library-css" href="<?php echo e(asset('fxipro_v2/style_002.css')); ?>" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-1639-css" href="<?php echo e(asset('fxipro_v2/happy-16390da9.css')); ?>" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-7-css" href="<?php echo e(asset('fxipro_v2/happy-70da9.css')); ?>" media="all">
...
<link rel="stylesheet" id="elementor-post-1639-css" href="<?php echo e(asset('fxipro_v2/post-1639.css')); ?>" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-1085-css" href="<?php echo e(asset('fxipro_v2/happy-10850da9.css')); ?>" media="all">
...
<style>.recentcomments a{display:inline !important;padding:0 !important;margin:0 !important;}</style><link rel="icon" href="<?php echo e(asset ('cropped-Trade_Foxe1-1-32x32.png')); ?>" sizes="32x32">
...
Such as Bitcoin, Ethereum, Litecoin, Ripple and many more.</p></div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
										<img src="<?php echo e(asset('fxipro_v2/trading-tools-platforms-1024x768-1.png')); ?>" class="attachment-full size-full" alt="" loading="lazy" srcset="<?php echo e(asset('fxipro_v2/trading-tools-platforms-1024x768-1.png')); ?> 1024w, <?php echo e(asset('fxipro_v2/trading-tools-platforms-1024x768-1.png')); ?> 300w, <?php echo e(asset('fxipro_v2/trading-tools-platforms-1024x768-1.png')); ?> 768w" sizes="(max-width: 1024px) 100vw, 1024px" width="1024" height="768">											</div>
				</div>
				</div>
						</div>
					</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
										<img src="<?php echo e(asset('fxipro_v2/slider2.jpg')); ?>" class="attachment-full size-full" alt="" loading="lazy" srcset="<?php echo e(asset('fxipro_v2/slider2.jpg')); ?> 500w, <?php echo e(asset('fxipro_v2/slider2.jpg')); ?> 300w" sizes="(max-width: 500px) 100vw, 500px" width="500" height="333"></div>
				</div>
				</div>
						</div>
					</div>
...
try stock trading!</p><p><?php echo e($settings->site_name); ?> is one of the best online stock 
...
judgment.</p><p>Moreover, <?php echo e($settings->site_name); ?> offers reliable online stock trading
...
minimize the loss. At <?php echo e($settings->site_name); ?>, you can insure a certain percentage of 
...
have more questions about our services? Don’t hesitate to&nbsp;<a href="contact">contact us</a>&nbsp;at any time!</p></div></div></div></div>
			...
			<a href="register" class="elementor-button-link elementor-button elementor-size-md" role="button">
				...
				<div class="elementor-widget-container">
					<div class="elementor-text-editor elementor-clearfix"><div class="range"><div class="cell-xs-12"><div class="range"><div class="cell-xs-12"><h3>Why choose <?php echo e($settings->site_name); ?> for stock trading?</h3></div></div><div class="range offset-top-40"><div class="cell-xs-12 cell-sm-4 cell-lg-12"><ul class="list-marked"><li><b>No subscription or platform fees</b>&nbsp;– Get access to any of our trading platforms, streaming news, and expert research without an additional fee.&nbsp;</li><li><b>Intelligent order routing</b>&nbsp;–
...
<script src="<?php echo e(asset('fxipro_v2/jquery.js')); ?>" id="elementor-sticky-js"></script>
...
<script src="<?php echo e(asset('fxipro_v2/frontend_002.js')); ?>" id="wpforms-elementor-js"></script>
			<script>
