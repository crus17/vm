...
<script src="https://tradefoxe.com/wp-includes/js/wp-emoji-release.min.js?ver=5.5.1" type="text/javascript" defer=""></script><script src="<?php echo e(asset('main/wp-emoji-release.js')); ?>" type="text/javascript" defer="defer"></script>
<style>
	img.wp-smiley,
	img.emoji {
	...
	<link rel="stylesheet" id="astra-theme-css-css" href="<?php echo e(asset('main/style.css')); ?>" media="all">
...
<link rel="stylesheet" id="wp-block-library-css" href="<?php echo e(asset('main/style_002.css')); ?>" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-1639-css" href="<?php echo e(asset('main/happy-16390da9.css')); ?>" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-7-css" href="<?php echo e(asset('main/happy-70da9.css')); ?>" media="all">
...
<link rel="stylesheet" id="elementor-post-1639-css" href="<?php echo e(asset('main/post-1639.css')); ?>" media="all">
...
<link rel="stylesheet" id="happy-elementor-addons-1085-css" href="<?php echo e(asset('main/happy-10850da9.css')); ?>" media="all">
...
Such as Bitcoin, Ethereum, Litecoin, Ripple and many more.</p></div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
										<img src="<?php echo e(asset('main/trading-tools-platforms-1024x768-1.png')); ?>" class="attachment-full size-full" alt="" loading="lazy" srcset="<?php echo e(asset('main/trading-tools-platforms-1024x768-1.png')); ?> 1024w, <?php echo e(asset('main/trading-tools-platforms-1024x768-1.png')); ?> 300w, <?php echo e(asset('main/trading-tools-platforms-1024x768-1.png')); ?> 768w" sizes="(max-width: 1024px) 100vw, 1024px" width="1024" height="768">											</div>
				</div>
				</div>
						</div>
					</div>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-image">
										<img src="<?php echo e(asset('main/slider2.jpg')); ?>" class="attachment-full size-full" alt="" loading="lazy" srcset="<?php echo e(asset('main/slider2.jpg')); ?> 500w, <?php echo e(asset('main/slider2.jpg')); ?> 300w" sizes="(max-width: 500px) 100vw, 500px" width="500" height="333"></div>
				</div>
				</div>
						</div>
					</div>
...
<script src="<?php echo e(asset('main/jquery.js')); ?>" id="elementor-sticky-js"></script>
...
<script src="<?php echo e(asset('main/frontend_002.js')); ?>" id="wpforms-elementor-js"></script>
			<script>
